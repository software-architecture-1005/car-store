...
import os
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-3m@o934zces3xd%y!^apsqo9q*@g4+bw*e)5c8ullc+@s=aj%5')
...
AUTH_USER_MODEL = 'core.User'  # Indica a Django que use nuestro modelo User personalizado
# Password validation
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        'rest_framework.permissions.AllowAny',  # Por defecto, permitir acceso público
    ),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Car Store API',
    'DESCRIPTION': 'API completa para gestión de tienda de carros',
    'VERSION': '1.0.0',
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  # Para React frontend
    "http://127.0.0.1:3000",
]
